...
import 'package:user_truvel/splashScreen/splash_screen.dart';
...
class _SignUpScreenState extends State<SignUpScreen>
{
  ...
  saveUserInfonow() async
  {
    ...
    if(firebaseUser != null)
    {
      ...
      DatabaseReference bikersRef = FirebaseDatabase.instance.ref().child("users");
      bikersRef.child(firebaseUser.uid).set(userMap);
